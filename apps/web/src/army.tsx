...
export function ArmyComposition({ army, view, busy, issue, inspectArmy }: {
  ...
  return <details className="army-composition" data-testid="army-composition">
    ...
    <div className="army-reorganization">
      ...
      {army.mergeOptionsTruncated && <p className="field-help">Showing the first {options.length} co-located destinations. Select the intended receiving army in the realm registry to reorganize a larger gathering.</p>}

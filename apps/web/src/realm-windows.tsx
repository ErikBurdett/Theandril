...
export function RealmRoster({ view, registry, search, force, selection, choose, setSearch, setForce, select, characters }: {
  ...
  return <section className="realm-roster">
    ...
    <section id="realm-registry-panel" role="tabpanel" aria-labelledby={`realm-tab-${registry}`}>
      ...
      <RealmRegistry view={view} registry={registry} search={search} force={force} selection={selection} select={select}/>
    </section>

...
export const libraryRevision = 'f78ed07d04ffbc3310d05e0124aa6d8f9d5a09e9';
...
export const scopeLedger: ScopeEntry[] = [
  ...
  { id: 'ai-integration', state: 'Open gate', title: 'Gate C & integration · Remaining campaign proof', description: 'The group-charters checkpoint passes 1,889 headless tests across 235 files, 12 affected Chromium journeys and one new built-production charter journey. It changes no rules or AI. Fleets retain their earlier observed supply and staging behavior, with recorded attrition and Standard/Long pacing limits. M0 and overall integration remain open.', path: 'docs/development/2026-09-24-group-charters/README.md' },
  { id: 'empire-delegation', state: 'Current / partial', title: 'Gate I · Orders across a large realm', description: 'Apply existing charter policies to up to 128 owned hearths, alongside group postings for land armies ashore. Separate selections survive search, pages and tabs. Partial refusals, preserved production queues, individual override and exact save restoration have authored browser evidence. Shared treasury limits are disclosed; saved templates, named groups, theaters and combined mature-empire acceptance remain open.', path: 'docs/development/2026-09-24-group-charters/README.md' },
...
export const roadmapSnapshot = { date: '2026-09-24', revision: libraryRevision, rules: 31 };
...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    delivered: ['Headless campaigns, battle-boundary saves, history replay and targeted production journeys have checkpoint-specific evidence.', 'The group-charters implementation checkpoint passes 1,889 headless tests across 235 files with four local workers, 12 affected Chromium journeys, one new built-production charter journey and the Pages-subpath build. These separate execution scopes precede publication of its dispatch; the full publication suite is recorded later.', 'The dated 21 September evidence retains its original 25 gameplay/27 Pages results and former Epic timing failure; it is historical context, not the latest full-suite result.'],
    ...
    gates: ['A', 'B', 'C', 'E', 'F', 'F2', 'G', 'H'], evidence: [charterEvidence, groupEvidence, fleetEvidence, campaignEvidence, reviewEvidence, gateEvidence],
  },
  {

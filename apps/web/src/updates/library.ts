...
export const libraryRevision = '3ae1581089411a76ecfd08a8f5f811258c4f77f6';
...
export const scopeLedger: ScopeEntry[] = [
  ...
  { id: 'ai-integration', state: 'Open gate', title: 'Gate C & integration · Remaining campaign proof', description: 'The group-postings checkpoint passes 1,876 headless tests, seven affected Chromium journeys and 27 production Pages checks. It changes no rules or AI. Fleets retain their earlier observed supply and staging behavior, with recorded attrition and Standard/Long pacing limits. M0 and overall integration remain open.', path: 'docs/development/2026-09-23-deploy-and-group-postings/README.md' },
  { id: 'empire-delegation', state: 'Current / partial', title: 'Gate I · Orders across a large realm', description: 'Select up to 128 land armies ashore across search and registry pages, issue existing Hold/Join postings together and inspect partial refusals in one final worker response. Individual override and save restoration pass in an authored 100-army realm. Named groups, theaters, patrols and combined mature-empire acceptance remain open.', path: 'docs/development/2026-09-23-deploy-and-group-postings/README.md' },
...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    delivered: ['Headless campaigns, battle-boundary saves, history replay and targeted production journeys have checkpoint-specific evidence.', 'The group-postings implementation checkpoint passes 1,876 headless tests across 234 files, seven affected Chromium journeys, 27 production Pages checks and the Pages-subpath build. These totals describe separate execution scopes and precede publication of its dispatch.', 'The dated 21 September evidence retains its original 25 gameplay/27 Pages results and former Epic timing failure; it is historical context, not the latest full-suite result.'],
    ...
    gates: ['A', 'B', 'C', 'E', 'F', 'F2', 'G', 'H'], evidence: [groupEvidence, fleetEvidence, campaignEvidence, reviewEvidence, gateEvidence],
  },
  {

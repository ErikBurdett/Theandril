...
export const libraryRevision = '3ed4a6c456c3e4130fddf35b44dfdf51034cc269';
...
export const scopeLedger: ScopeEntry[] = [
  ...
  { id: 'ai-integration', state: 'Open gate', title: 'Gate C & integration · Remaining campaign proof', description: 'The charter-templates checkpoint passes 1,902 headless tests across 237 files, 16 affected Chromium journeys and one separate built-production template journey. It changes no rules or AI. Fleets retain their earlier observed supply and staging behavior, with recorded attrition and Standard/Long pacing limits; these are historical results, not new measurements. M0 and overall integration remain open.', path: 'docs/development/2026-09-25-charter-templates/README.md' },
  { id: 'empire-delegation', state: 'Current / partial', title: 'Gate I · Orders across a large realm', description: 'Apply existing charter policies to up to 128 owned hearths, alongside group postings for land armies ashore. Keep up to 24 named focus/ceiling templates in this browser; Recall fills the form and Apply remains explicit. Existing queues, partial refusals and individual overrides retain their ordinary behavior. Templates are excluded from campaign exports. Broader order templates, named groups, theaters and combined mature-empire acceptance remain open.', path: 'docs/development/2026-09-25-charter-templates/README.md' },
...
export const roadmapSnapshot = { date: '2026-09-25', revision: libraryRevision, rules: 31 };
...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    summary: 'Searchable registries apply policies to up to 128 owned hearths or post up to 128 land armies ashore. A personal browser library recalls named charter policies for explicit assignment. ACT-32 and wider M3 coordination remain in progress.',
    ...
    remaining: ['Extend charters and postings with broader governor decisions, durable named groups, bounded theaters, patrol/escort roles, saved reusable army order templates, production sequences and coordinated orders, keeping inspectable blockers and clear overrides.', 'Complete broader governor decisions, onboarding, accessible keyboard/tooltip workflows, durable settings and critical canvas alternatives for all major systems; group assignment and personal charter templates do not complete them.', 'Prove combined delegation and override in representative mature campaigns with 100+ armies and many settlements; the authored group-order fixture is a bounded checkpoint. Profile sustained query transfers and virtualize large registries where needed.'],
    gates: ['I'], evidence: [templateEvidence, charterEvidence, groupEvidence, statusEvidence, gateEvidence],
  },
  {
  ...
  },
  {
    ...
    delivered: ['Headless campaigns, battle-boundary saves, history replay and targeted production journeys have checkpoint-specific evidence.', 'The charter-templates implementation checkpoint passes 1,902 headless tests across 237 files with four local workers, 16 affected Chromium gameplay journeys, one separate built-production template journey and the Pages-subpath build. These overlapping execution scopes are not added together; they precede publication of its dispatch and its separate publication checks.', 'The dated 21 September evidence retains its original 25 gameplay/27 Pages results and former Epic timing failure; it is historical context, not the latest full-suite result.'],
    ...
    gates: ['A', 'B', 'C', 'E', 'F', 'F2', 'G', 'H'], evidence: [templateEvidence, charterEvidence, groupEvidence, fleetEvidence, campaignEvidence, reviewEvidence, gateEvidence],
  },
  {

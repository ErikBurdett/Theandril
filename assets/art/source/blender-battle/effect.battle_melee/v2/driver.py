...
def main():
    ...
    scene['presentation_note'] = 'Keyed poses are frames 1–8; playback uses retained per-frame durations, not timeline fps.'
    anchors, poses = [], []
    ...
    metadata = {'blenderVersion': bpy.app.version_string, 'renderEngine': scene.render.engine,
                ...
                'animatedObjects': sum(obj.animation_data is not None for obj in meshes), 'description': description}

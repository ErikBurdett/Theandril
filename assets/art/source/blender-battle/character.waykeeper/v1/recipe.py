...
def build(ctx):
    for name, color in [('coat', '#657680'), ('coatshadow', '#3c4d58'), ('trouser', '#45414b'),
                        ('leather', '#553e2c'), ('linen', '#b7a07a'), ('skin', '#a67358'),
                        ('hair', '#544938'), ('copper', '#977544'), ('wood', '#63513b'), ('coal', '#f2bc60')]:
    ...
    ctx.sphere('close swept hair', (0, .015, 1.78), (.108, .098, .095), 'hair', smooth=False)
    ctx.sphere('nose', (0, -.124, 1.70), (.034, .043, .035), 'skin', smooth=False)
    ctx.mesh('quiet brow line', [(-.075, -.12, 1.738), (.075, -.12, 1.738), (.068, -.125, 1.722), (-.068, -.125, 1.722)], [(0, 1, 2, 3)], 'hair')

...
if (Number(SAVE_VERSION) !== 10 || CONTENT_HASH !== '4c2fed32') throw new Error('Capture requires untouched schema10/content4c2fed32.');
...
const payload = {
  capturedBefore: 'Automatic city borders and expanded practical research', saveVersion: SAVE_VERSION, contentHash: CONTENT_HASH,

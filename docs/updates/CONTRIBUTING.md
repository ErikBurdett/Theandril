...
6. Update the scope ledger and links to the canonical scope/status documents. Explicitly identify additions, cuts, deferrals, and unresolved defects. A declined idea is not a new 1.0 obligation.

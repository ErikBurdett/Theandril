...
+           ],
+           "path": [],
+           "message": "Invalid input: expected 5"
+         }
+       ],
+       [
+         {
...
+           ],
+           "path": [],
+           "message": "Invalid input: expected 6"
+         }
+       ],
+       [
+         {
...
+           ],
+           "path": [],
+           "message": "Invalid input: expected 7"
+         }
+       ],
+       [
+         {
...
+           ],
+           "path": [],
+           "message": "Invalid input: expected 10"
+         }
+       ],
+       [
+         {
...
+           ],
+           "path": [],
+           "message": "Invalid input: expected 11"
+         }
+       ],
+       [
+         {
...
+           ],
+           "path": [],
+           "message": "Invalid input: expected 12"
+         }
+       ],
+       [
+         {
...
+           ],
+           "path": [],
+           "message": "Invalid input: expected 13"
+         }
+       ],
+       [
+         {
...
+           ],
+           "path": [],
+           "message": "Invalid input: expected 14"
+         }
+       ],
+       [
+         {
...
+           ],
+           "path": [],
+           "message": "Invalid input: expected 15"
+         }
+       ],
+       [
+         {
...
+           ],
+           "path": [],
+           "message": "Invalid input: expected 16"
+         }
+       ]
+     ],
+     "path": [
...
Call log:
  ...
  - waiting for getByTestId('feedback')
    2 × locator resolved to <div role="status" class="feedback " aria-live="polite" data-testid="feedback">…</div>
      - unexpected value "◆Resolving… Your people await a hearth. Select the caravan and found your first settlement."
    12 × locator resolved to <div role="alert" aria-live="polite" class="feedback error" data-testid="feedback">…</div>
       - unexpected value "![
  {
    "code": "invalid_union",
    "errors": [
...
```yaml
- alert: "[ { \"code\": \"invalid_union\", \"errors\": [ [ { \"code\": \"invalid_value\", \"values\": [ 4 ], \"path\": [], \"message\": \"Invalid input: expected 4\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 5 ], \"path\": [], \"message\": \"Invalid input: expected 5\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 6 ], \"path\": [], \"message\": \"Invalid input: expected 6\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 7 ], \"path\": [], \"message\": \"Invalid input: expected 7\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 8 ], \"path\": [], \"message\": \"Invalid input: expected 8\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 9 ], \"path\": [], \"message\": \"Invalid input: expected 9\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 10 ], \"path\": [], \"message\": \"Invalid input: expected 10\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 11 ], \"path\": [], \"message\": \"Invalid input: expected 11\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 12 ], \"path\": [], \"message\": \"Invalid input: expected 12\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 13 ], \"path\": [], \"message\": \"Invalid input: expected 13\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 14 ], \"path\": [], \"message\": \"Invalid input: expected 14\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 15 ], \"path\": [], \"message\": \"Invalid input: expected 15\" } ], [ { \"code\": \"invalid_value\", \"values\": [ 16 ], \"path\": [], \"message\": \"Invalid input: expected 16\" } ] ], \"path\": [ \"header\", \"initialSaveVersion\" ], \"message\": \"Invalid input\" } ]"
```

...
import { CAMPAIGN_PACES, checksum, LEGACY_CAMPAIGN_PACES, SCHEMA8_CAMPAIGN_PACES, SCHEMA17_CAMPAIGN_PACES, SCHEMA20_CAMPAIGN_PACES, SCHEMA21_CAMPAIGN_PACES, TECHNOLOGIES } from '@theandril/content';
...
describe('canonical campaign pace', () => {
  ...
  it.each([
    ...
    { version: 21, price: SCHEMA21_CAMPAIGN_PACES.epic.projectCoinCost },
    { version: 22, price: CAMPAIGN_PACES.epic.projectCoinCost },

...
Open the local Vite address, choose a world size, faction count and player culture, and begin a campaign. Leave Seed empty for a fresh random world each time; enter an explicit seed to reproduce a world. New campaign clears the optional seed, while loading preserves the saved world. Size changes suggest 4/12/24/32/40 seats. New campaigns use roster version 4: all twenty-four authored cultures are available, with distinct definitions used before any repeated seats. Campaigns with 24 or more realms include all 24 cultures; additional seats inherit those cultures rather than becoming new identities. Each culture has explicit biome benefits, drawbacks and cultivation targets; generated starts prefer suitable existing sites without rewriting the physical world. Select the hearth caravan to found a settlement. Select the settlement to build or recruit. Click an army, then a highlighted hex to move along its known route within the current movement budget; hover previews the path and cost. Clicking a reachable hostile army approaches and attacks, without declaring war automatically. At nearby zoom, click stacked friendly armies to cycle selection; dragging pans, and Escape clears selection. End turn resolves the economy and AI orders. Manual saves and three rotating autosaves use IndexedDB. Exported campaigns use the compressed `.theandril` format.
...
With a settlement selected, click a surrounding map hex or use **Select tiles** to inspect its land. The floating **Land & tiles** tab puts the selected tile's real actions and prices first; the full orders window retains the complete settlement overview. The center works automatically; available households can work other claimed tiles. Settlement count, population and connected territory have no fixed gameplay ceiling. Larger hearths need more food and upkeep; new settlements and distant claims become more expensive. Large land lists use pages. Population 1–2 is a colony, 3–7 a settlement, and 8+ a city; **Designate capital** remains a separate paid choice. Outer realm borders mark ownership; the selected town's inspector identifies its own claims. Ownership does not grant military access rights.

Open **World map · Terrain** and choose **Realms** to fit the world overview and color known territory by faction. Select individual realms, show all known realms, or clear their colors. Dim territory is remembered ownership; unexplored territory stays hidden. These controls affect map presentation only.

New campaigns contain Hearthgrain, Ironstone, Redcopper, Whitesalt, Heartwood, Steppehorses, Witnesssilver and Ashglass deposits where geography supports them. Claim and inspect a deposit to build its matching farm, mine, salt house, timber yard, remount yard or refinery. Finish the works and assign a household to extract stock each turn. The **Resources** tab shows stocks, production and market contracts; advanced development consumes materials. Older campaigns retain their original geography and have no retroactively added deposits.

The **Development** tab contains branching company training, hearth specializations and faction traditions, with prerequisites, permanent choices and exact costs. Companies earn experience from surviving combat; hearths accumulate civic points and realms gain influence. Character promotion adds advanced officer branches. Acquired choices change the actual economy or battle stats and can add upkeep.

New battles show each surviving soldier in a formation and one actor per naval hull. Advance, brace and flank change position and cohesion; frontage, ranged attacks, armor, pike screens and mounted charges influence the seeded combat. Thirteen role sheets provide independent facing, movement, attack, hit and death animations. Use **Battle view** for Fit field or 2×–4× detail, **Focus selected** to center a company, and the battlefield arrows to pan. Playback speed, pause and skip never decide combat outcomes. Historical battles retain their recorded combat rules.
...
Hearths visibly spread across their claimed land as population grows. Completed cellars, workshops, markets, archives and harbors have distinct district artwork; housing uses the settlement’s culture. Scaffolds show active construction, worked ground has furrows, and finished improvements reshape their tile. These visual neighborhoods stay inside known claims and do not add unearned yields or movement roads. Zoomed-out town and army badges stay readable and can be clicked directly to inspect the correct entity.

Large empires publish compact town summaries; selecting a town requests a bounded page of its current tile details. Loading and retry states keep outdated prices from becoming actionable. Selecting another tile in the same town reuses its details, while paid orders, save loads and campaign changes invalidate them. Map updates transfer packed observed-cell deltas without changing fog or saved geography.

Thirteen formation types are available: ten land roles and three naval hulls. Reed skirmishers, Witness arbalesters, Kiln halberdiers and Road lancers add distinct speed, range, armor and striking-power choices behind research and building requirements. They use the normal paid recruitment, upkeep, army, battle and save rules. Their campaign-map faction silhouettes share the appropriate wayfinder, pike and outrider kits. Battles use thirteen separate animated role sheets, with culture-specific banners.

An unled army commands twelve formations. A healthy attached marshal commands sixteen; earned **Muster rolls** and **Field orders** raise that to eighteen and twenty. Recruit companies, gather them on the same hex and open **Army composition** to merge, transfer or split checked formations into a named detachment. The slowest formation sets movement, the best scout sets sight, and upkeep adds across the roster. Losing the commander preserves every formation but limits an oversized army to one movement until a replacement or reorganization restores command. Reorganizing never restores movement or losses. Nearby map armies show one figure for a single formation, two for two–five, and three for six or more; inspect the roster for exact composition. Co-located friendly forces share one representative group and a small ×N army count; the selected army is shown, otherwise the largest. At nearby zoom, click repeatedly to cycle the separate armies, without merging their rosters. At far zoom, clicking a badge inspects its displayed representative; use the map popup or registry to select another army. Fleets group separately and count their hull formations, without drawing embarked passengers again. Far zoom keeps compact faction badges.
...
Field battles, siege assaults and naval engagements show individual surviving soldiers, formation strength and attached officers. Each naval formation appears as one hull; transported passengers are not extra naval combatants. Historical battles preserve their earlier formation presentation. Choose **Watch battle**, pause, change playback speed, or **Step one battle round**. Tactical orders and **Auto-resolve** use the same deterministic kernel. Open **Formation details & round account** for the full roster and round ledger. **Watch recorded battle actions** replays the latest retained participant battle without changing the campaign; loading restores the current battle, not unrecorded past animations.

...
- Name: army.spec.ts >> mixed armies merge, split and transfer stable formations without refreshing movement; an escorted caravan founds without consuming its scouts
- Location: tests/gameplay/army.spec.ts:49:1
